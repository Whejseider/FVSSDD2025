...
export default function Footer() {
    return (
        <footer className="bg-white shadow-sm w-full mt-auto relative z-50"
            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <Link href="/"
                        ...
                        <span
                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Pokédex</span>
                    </Link>
                </div>
